<template>
    <b-form>
        ...
        <b-form-group v-if="ticketData.friendsOfMassey === 'student'">
            <b-form-group label="Year Graduated (if you didn't graduate, the last year you attended)*">
                <b-select class="form-control" id="exampleFormControlSelect1" v-model.number="ticketData.gradYear">
