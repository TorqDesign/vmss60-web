<template>
    <form>
        ...
        <div v-if="ticketData.friendsOfMassey === 'student'">
            <div class="form-group">
                <label for="exampleFormControlSelect1">Year graduated</label>
                <select class="form-control" id="exampleFormControlSelect1" v-model.number="ticketData.gradYear">
                    <option v-for="i in 60">{{1960 + i}}</option>
                </select>
            </div>
            <div class="form-group">
                <label>Status</label>
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="address-line1" name="address-line1" type="text" placeholder="address line 1"
                           class="input-xlarge" v-model="ticketData.address.line1">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="address-line2" name="address-line2" type="text" placeholder="address line 2"
                           class="input-xlarge" v-model="ticketData.address.line2">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="region" name="region" type="text" placeholder="state / province / region"
                           class="input-xlarge" v-model="ticketData.address.state">
                    <p class="help-block"></p>
                </div>
            </div>
            <!-- postal-code input-->
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="postal-code" name="postal-code" type="text" placeholder="zip or postal code"
                           class="input-xlarge" v-model="ticketData.address.postal">
                    <p class="help-block"></p>
                </div>
            </div>
            <!-- country select -->
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="country" name="country" class="input-xlarge" v-model="ticketData.address.country">
